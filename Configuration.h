...
#define CUSTOM_MACHINE_NAME "Snell3D"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ridgid 3mm M303 E0 S200 C10
#define  DEFAULT_Kp 24.19
#define  DEFAULT_Ki 1.50
#define  DEFAULT_Kd 97.48


  //Ridgid 1.75mm M303 E0 S200 C10
//#define  DEFAULT_Kp 64.82
//#define  DEFAULT_Ki 6.87
//#define  DEFAULT_Kd 152.94

  // FlexyStruder 3mm M303 E0 S200 C10
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
	#define  DEFAULT_bedKp 217.30
	#define  DEFAULT_bedKi 35.65
	#define  DEFAULT_bedKd 331.11
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  //    O-- FRONT --+
  //  (0,0)
  #define X_PROBE_OFFSET_FROM_EXTRUDER 0  // IGNORE: Use UltraLCD.cpp Head select menu for Gcode offset -- X offset: -left  +right  [of the nozzle]
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 0  // IGNORE: Use UltraLCD.cpp Head select menu for Gcode offset -- Y offset: -front +behind [the nozzle]
...
//steps_per_mm = (motor_steps_per_rev {200}* driver_microstep{16}) /
//(belt_pitch{2} * pulley_number_of_teeth{varies})
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,96.5}  // default steps per unit for Ultimaker
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {40,81.30,400,96.5}  // default steps per unit for Ultimaker
//#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 40}    // (mm/sec)
...
//#define DEFAULT_EJERK                 5.0    // (mm/sec)
				...
				//3.0mm FlexyStruder
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,96.5}  // default steps per unit for Ultimaker
#define DEFAULT_AXIS_STEPS_PER_UNIT   {40,81.30,400,968}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 40}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3000,3000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define SERVO_ENDSTOP_ANGLES {{90,0}, {90,0}, {22,180}} // X,Y,Z Axis Extend and Retract angles
...
#define DEACTIVATE_SERVOS_AFTER_MOVE
  ...
  #define SERVO_DEACTIVATION_DELAY 800
#endif
