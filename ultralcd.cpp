...
static void lcd_status_screen();
  ...
  static void lcd_head_menu(); //Head selection menu
...
static void lcd_main_menu() {
  ...
  if (movesplanned() || IS_SD_PRINTING) {
	...
	MENU_ITEM(submenu, MSG_HEAD_SELECT, lcd_head_menu); //Multi-Head selection addition
    #if ENABLED(DELTA_CALIBRATION_MENU)
...
void small(){
    enqueue_and_echo_commands_P(PSTR("G28")); // move all axes home
    enqueue_and_echo_commands_P(PSTR("M206 X-25 Y-67 Z0"));
    enqueue_and_echo_commands_P(PSTR("M851 Z-19"));
	//enqueue_and_echo_commands_P(PSTR("M500"));
}
void flexy(){
    enqueue_and_echo_commands_P(PSTR("G28")); // move all axes home
...
void laser(){
    enqueue_and_echo_commands_P(PSTR("G28")); // move all axes home
    enqueue_and_echo_commands_P(PSTR("M206 X-32 Y-64 Z-27.66"));
    enqueue_and_echo_commands_P(PSTR("M500"));
}
void lcd_head_menu() {
  ...
  // Auto Home
  //
  MENU_ITEM(function, MSG_SOLID3HEAD_HOME, big);
  MENU_ITEM(function, MSG_SOLID175HEAD_HOME, small);
  MENU_ITEM(function, MSG_FLEXYHEAD_HOME, flexy);
  MENU_ITEM(function, MSG_LASERHEAD_HOME, laser); 
